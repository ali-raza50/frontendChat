...
import { SetState, SignIn, ClearState, NewUser } from '../../redux/reducers/auth';
...
const SignUp = () => {
  ...
  const { err, signup, loading, message } = useSelector((state: RootState) => state.auth);
  ...
  const handleSubmit = () => {
    const { name, email, password, confirmPassword, agreePolicy } = signUpObject;
          ...
          >
            ...
            <small style={styles.textLeft}>
              ...
              <Checkbox
                ...
                checked={signUpObject.agreePolicy || false}
                name='agreePolicy'
                onChange={handleInputChange}
              />{' '}
