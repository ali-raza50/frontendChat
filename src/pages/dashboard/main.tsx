    ...
    <>
      <div className='min-vh-100'>
        <Row className='min-vh-100'>
          ...
          <Col lg={4} sm={5} xl={3} className='main-container-chat'>
            <div className="custom-container">
              ...
              <div className='d-flex flex-column align-items-center overflow-scroll-chats-list pt-2'>
                {
                  activeTab === 'contacts' && (
            ...
            <div className="second-div">
              ...
              <div className='d-flex flex-column align-items-center overflow-scroll-call-list pt-2'>
          ...
          <Col lg={7} sm={5} xl={8} className='main-chat p-0 d-flex flex-column'>
